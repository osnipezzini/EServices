...
from ui.product_ui import ProductForm, SearchOptions
...
class ProductView(ProductForm):
    ...
    def new_client(self, event):
        ...
        self.text_group_grid.SetValue('2')
        self.text_group_name.SetValue('CONVENIENCIA')
...
class ProductSearchView(Search):
    def __init__(self, parent):
        super(ProductSearchView, self).__init__(parent)
        self.SetIcon(get_icon())
