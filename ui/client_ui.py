...
class ClientForm ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		bSizer61.Add( self.m_checkBox1, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		self.text_group_grid = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.text_country_name = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer12.Add( self.text_country_name, 1, wx.ALL, 5 )
